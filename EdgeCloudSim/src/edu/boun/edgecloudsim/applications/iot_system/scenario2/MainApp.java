...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/iot_system/scenario2/config/default_config.properties";
			applicationsFile = "scripts/iot_system/scenario2/config/applications.xml";
			edgeDevicesFile = "scripts/iot_system/scenario2/config/edge_devices.xml";
			outputFolder = "sim_results/iot_system/scenario2/ite" + iterationNumber;
		}
