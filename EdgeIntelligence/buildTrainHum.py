...
try:
    ...
    model_checkpoint = ModelCheckpoint('checkpointHum/'+'model_hum_{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='auto')
